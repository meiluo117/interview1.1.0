...
#define APP_UPDATAURL @"https://itunes.apple.com/cn/app/yue-tanyt/id1092458285?mt=8"
                    ...
                    for (int i = 0; i<count; i++) {
                        if ([[appstoreVersionAry objectAtIndex:i] intValue]>[[currentVersionAry objectAtIndex:i] intValue]){
                            ...
                            dispatch_async(dispatch_get_main_queue(), ^{
                                ...
                                Alert *alert = [[Alert alloc] initWithTitle:@"有新版本更新" message:nil delegate:nil cancelButtonTitle:@"关闭" otherButtonTitles:@"更新", nil];
...
#else
                                if (IS_VAILABLE_IOS8) {
                                    UIAlertController *alert = [UIAlertController alertControllerWithTitle:@"有新版本更新" message:nil preferredStyle:UIAlertControllerStyleAlert];
                                    ...
                                    UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"有新版本更新" message:nil delegate:self cancelButtonTitle:@"关闭" otherButtonTitles:@"更新", nil];
                                    [alert show];
#endif
                                }
#endif
...
//        }];
        ...
        [[UIApplication sharedApplication] openURL:[NSURL URLWithString:APP_UPDATAURL]];
    });
}
