...
- (void)setup
{
    ...
    self.HYbgColor = [UIColor colorWithRed:1 green:1 blue:1 alpha:0.95f];
    ...
    [self.cancelButton setTitleColor:btnColor forState:UIControlStateNormal];
...
- (void)hide
{
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:SharedHide object:nil];
...
- (void)setHYbgColor:(UIColor *)HYbgColor
{
    _HYbgColor = HYbgColor;
    self.contentView.backgroundColor = HYbgColor;
